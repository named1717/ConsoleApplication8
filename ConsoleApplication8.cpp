...
int started = 0;
int cX[16] = { 300,450,600,750,300,450,600,750, 300,450,600,750, 300,450,600,750 };
int cY[16] = { 470,470,470,470,320,320,320,320,170,170,170,170,20,20,20,20 };
int element_check(int pX[], int pY[], int size) {
...
bool checkin(int x, int y, int cx, int cy, int r) {
	return ((x == cx && abs(y - cy) <= 150) || (y == cy && abs(x - cx) <= 150));
}
